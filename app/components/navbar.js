  ...
  return (
    <nav className="bg-white text-black w-full px-6 py-3 flex justify-between items-center shadow shadow-[0_0_15px_#78aedb] sticky top-0 z-10">
      ...
      <div className="space-x-4 hidden md:flex items-center">
        <a
          href="/"
          className="relative group overflow-hidden text-black flex items-center"
        >
          Home
          <span
            className={`absolute left-0 bottom-0 h-[2px] w-full bg-[#78aedb] transform ${pathname === '/' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
        ...
        >
          About
          <span
            className={`absolute left-0 bottom-0 h-[2px] w-full bg-[#78aedb] transform ${pathname === '/about' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
              } transition-transform duration-150 origin-center`}
          ></span>
        </a>
        <p>|</p>
        ...
        >
          Contact
          <span
            className={`absolute left-0 bottom-0 h-[2px] w-full bg-[#78aedb] transform ${pathname === '/contact' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
              } transition-transform duration-150 origin-center`}
          ></span>
        </a>
        {isAuthenticated ? (
